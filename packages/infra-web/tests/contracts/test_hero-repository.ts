import { WebHeroRepository } from '../../src/repositories/hero-repository';
...
describe('WebHeroRepository - Contract Tests', () => {
  let repository: IHeroRepository;

  beforeEach(() => {
    repository = new WebHeroRepository();
  });
  ...
  describe('Error handling', () => {
    ...
    it('should handle JSON parsing errors gracefully', () => {
      ...
      const testRepository = new WebHeroRepository();
