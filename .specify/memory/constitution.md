...
Modified principles: All principles replaced with mobile app specific ones
Added sections: Clean Architecture Layers, Dependency Injection, State Management, Testing Strategy, Platform Targets
...
- HTTP clients, storage adapters, native module bridges
